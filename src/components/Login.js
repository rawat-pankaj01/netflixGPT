    ...
    <div>
      ...
      <form className='w-3/12 p-12 bg-black absolute my-36 mx-auto right-0 left-0 text-white bg-opacity-80'>
        <h1 className='font-bold text-3xl py-4'>{ isSignInForm ? 'Sign In' : 'Sign Up'}</h1>
         { !isSignInForm && <input type="text" placeholder='Enter your name' className='p-2 my-4 w-full bg-slate-800'/> }
        <input type="email" placeholder='Email or mobile number' className='p-2 my-4 w-full bg-slate-800'/>
        <input type="password" placeholder='Password' className='p-2 my-4 w-full bg-slate-800'/>
